...
{/foreach}
    ...
    <tr>
        <td>
            <a class="body" tabindex=1 href="" onClick="return popup(this, 'Help')" style="text-decoration:none">{$g_lang_label_file_location}</a>
        </td>
        <td colspan=3>
...
{/if}    
    <tr>
        <td>
            <a class="body"   onClick="return popup(this, 'Help')" style="text-decoration:none">{$g_lang_category}</a>
        </td>
        <td colspan=3>
    ...
    <tr id="departmentSelect">
        <td>
            <a class="body"  onClick="return popup(this, 'Help')" style="text-decoration:none">{$g_lang_addpage_permissions}</a>
        </td>
        <td colspan=3>
            <hr />
    ...
    <tr>
        <td>
            <a class="body"  onClick="return popup(this, 'Help')" style="text-decoration:none">{$g_lang_label_description}</a>
        </td>
    ...
    <tr>
        <td>
            <a class="body"  onClick="return popup(this, 'Help')" style="text-decoration:none">{$g_lang_label_comment}</a>
        </td>
