<?php /* Smarty version 2.6.26, created on 2014-12-23 00:49:33
         compiled from /Applications/XAMPP/xamppfiles/htdocs/GALIH//templates/common/add.tpl */ ?>
...
" /> <!-- CHM hidden and onsubmit added-->
    <tr>
        <td>
            <a class="body" tabindex=1 href="" onClick="return popup(this, 'Help')" style="text-decoration:none"><?php echo $this->_tpl_vars['g_lang_label_file_location']; ?>
</a>
        </td>
        <td colspan=3>
...
<?php endif; ?>    
    <tr>
        <td>
            <a class="body"   onClick="return popup(this, 'Help')" style="text-decoration:none"><?php echo $this->_tpl_vars['g_lang_category']; ?>
</a>
        </td>
        <td colspan=3>
...
"><?php echo $this->_tpl_vars['cat']['name']; ?>
    ...
    <tr id="departmentSelect">
        <td>
            <a class="body"  onClick="return popup(this, 'Help')" style="text-decoration:none"><?php echo $this->_tpl_vars['g_lang_addpage_permissions']; ?>
</a>
        </td>
        <td colspan=3>
            <hr />
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <tr>
        <td>
            <a class="body"  onClick="return popup(this, 'Help')" style="text-decoration:none"><?php echo $this->_tpl_vars['g_lang_label_description']; ?>
</a>
        </td>
    ...
    <tr>
        <td>
            <a class="body"  onClick="return popup(this, 'Help')" style="text-decoration:none"><?php echo $this->_tpl_vars['g_lang_label_comment']; ?>
</a>
        </td>
