<?php /* Smarty version 2.6.26, created on 2014-11-26 20:34:49
         compiled from C:%5Cxampp%5Chtdocs%5Csystem//templates/common/deleteview.tpl */ ?>
<table class="form-table">
 ...
 echo msg('button_reject')<?php echo '?>'; ?>
		...
		-->
                <button class="positive" type="submit" name="submit" value="Undelete"><?php echo $this->_tpl_vars['g_lang_button_undelete']; ?>
</button>
		<button class="negative" type="submit" name="submit" value="Delete file(s)"><?php echo $this->_tpl_vars['g_lang_button_delete_files']; ?>
</button>
                        </div>
